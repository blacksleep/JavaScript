/**
 * Created by BlackSleep on 11/13/2014.
 */
...
var employees = [
    {
        name : "David",
        phone: "800-555-5555",
        address: "123 Main Street Denver, CO 80207"
    },

    {
        name : "Bob",
        phone: "303-123-4567",
        address: "455 Maple Road Denver, CO 80209"
...
function render_edit_box(type, employee, index){
    ...
    var button_name = type == "add" ? "Add them" : "Update them";

    html += "<button id='saveit'>"+ button_name + "</button>";

    $('#edit_box').html(html).slideToggle();
