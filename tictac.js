/**
 * Created by BlackSleep on 10/22/2014.
 */
...
/*$(document).ready(function(){
    ...
    function click(){
        ...
        if(el.text() !== '') return msg.text('already played');
        ...
        if(total_moves == 9 && game_over == false){ //cat, bitch!
            game_over = true;
    ...
    function checkForWin(){
        ...
        transpose(board)lforEach(checkAndMark);

        var diagonal1 = [board[0][0], board[1][1], board[2][2];
        var diagonal2 = [board[1][2], board[1][1], board[2][0];
